...
<body>
    ...
    <main>
        ...
        $query = 'INSERT INTO seele
            (save_name, save_atkv, save_spdv, save_critv, save_qdbv, save_batkv, save_skillv, save_ultv)
        VALUES
            ("'.$_GET['name'].'", '.$atkv.', '.$spdv.', '.$critv.', '.$qdbv.', '.$batkv.', '.$skillv.', '.$ultv.')';
        ...
        <div class="back">
            <a class="backb" href="seele.php">Confirm</a>
        </div>
